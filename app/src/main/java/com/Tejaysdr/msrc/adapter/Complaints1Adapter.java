...
public class Complaints1Adapter extends BaseAdapter {
    static Context context;
    ArrayList<InventoryData>list;
    private Date dt;
    private String date4;

    public Complaints1Adapter(Context playlistFragment, ArrayList<InventoryData> vList) {
        list = vList;
...
//        final InventoryData tag = list.get(position);
      view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_list_view1, viewGroup, false);
