...
public class PendingleaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pendingleave);
...
//            progressdialog.setCancelable(false);
            ...
            dialog.show();
            final String url = BaseUrl.getBaseurl() +"employee/pending_leave_requests";
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (message.equalsIgnoreCase("success")) {
                                        ...
                                        leaveListAdapter = new LeaveListAdapter(PendingleaveActivity.this, leadHistorylist,"Pending");
                                        ...
                                        Toast.makeText(PendingleaveActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
...
//                                DashboardActivity.getInstance().removeLocationUpdates();
                                Intent i = new Intent(PendingleaveActivity.this, EMPLoginActivity.class);
