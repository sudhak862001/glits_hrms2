...
public class CompletedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout=view.findViewById(R.id.swipelayout10);

        complaintslist = view.findViewById(R.id.complaintlist6);
        ...
        tv_norecords=view.findViewById(R.id.tv_norecords3);
...
//                updateintent.putExtra("spinnerstatus","Closed");
