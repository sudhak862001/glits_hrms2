...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent == null) {
            Toast.makeText(getApplicationContext(), "No Intent Found", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(ImagePickerActivity.this, getResources().getString(R.string.file_provider_authority), image);
    }
