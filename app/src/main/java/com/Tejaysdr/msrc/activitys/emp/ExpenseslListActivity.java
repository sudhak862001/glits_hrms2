...
public class ExpenseslListActivity extends AppCompatActivity {
   ...
   private  String FCMToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expensesl_list);
...
//        editor.commit();
        ...
        setTitle("Pending Expenses List");
    ...
    private void getReturnsInfo() {
        try {
            ...
            dialog.show();
             String url = BaseUrl.getBaseurl() +"employee/pending_expenses_list_new";
...
//                                        Logout();
                                    ...
                                    if (message.equalsIgnoreCase("success")) {
                                        ...
                                        expenseBdeAdapter = new ExpenseBdeAdapter(ExpenseslListActivity.this, leadHistorylist, "pending");
                                        ...
                                        Toast.makeText(ExpenseslListActivity.this, "No Data Found", Toast.LENGTH_SHORT).show();
