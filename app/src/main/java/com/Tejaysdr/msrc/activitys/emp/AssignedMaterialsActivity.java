...
public class AssignedMaterialsActivity extends AppCompatActivity {
    TextView empname;
    ...
    Toolbar toolbar_mlist2;
    boolean openremark;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assigned_materials);
        openremark = false;
        ...
        inventorylist=(ListView)findViewById(R.id.inventorylist1);
        toolbar_mlist2=findViewById(R.id.toolbar_mlist2);
        setSupportActionBar(toolbar_mlist2);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
       toolbar_mlist2.getNavigationIcon().setColorFilter(getResources().getColor(R.color.white), PorterDuff.Mode.SRC_ATOP);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
        setTitle("Assigned materials");
        String getempname=operatorCode.getFullname();
        empname.setText("Hello "+getempname);
        String getempID=operatorCode.getEmp_id();
        getAssignedmaterials(getempID);
    }
    @Override
    ...
    private void getAssignedmaterials(String getempID) {
                ...
                try {
                    ...
                    if (response12.equalsIgnoreCase("Success")) {
                        ...
                        while (keys.hasNext()) {
                            ...
                            InventoryAssignedAdapter adapter=new InventoryAssignedAdapter(AssignedMaterialsActivity.this,inventoryDataList);
                            inventorylist.setAdapter(adapter);
                        }
                    }
                    else {
                        dialog.dismiss();
                        Toast.makeText(AssignedMaterialsActivity.this, ""+response12, Toast.LENGTH_SHORT).show();
                    }
