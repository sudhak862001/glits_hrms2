...
public class ResolvedFragment extends Fragment {
    ...
    TextView empname,tv_norecords1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout=view.findViewById(R.id.swipelayout9);
        complaintslist = view.findViewById(R.id.complaintlist5);
        ...
        tv_norecords1=view.findViewById(R.id.tv_norecords1);
...
//                updateintent.putExtra("spinnerstatus","Resolved");
//                updateintent.putExtra("complaintstatus",complaintData.getCompCategory());
    ...
    private void GetComplaintInfo() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (message.equalsIgnoreCase("Success")) {
                        ...
                        while (keys.hasNext()) {
                            ...
                            tv_norecords1.setVisibility(View.GONE);
                        }
                    } else {
                        tv_norecords1.setVisibility(View.VISIBLE);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("comp_status", "Resolved");
                return params;
            }
        };
